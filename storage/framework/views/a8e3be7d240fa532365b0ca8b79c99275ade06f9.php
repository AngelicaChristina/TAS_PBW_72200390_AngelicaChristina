        ...
        <div class="row">
            ...
            <div class="col-lg-10 vh-100">
                ...
                <form action="/mahasiswa/simpanmahasiswa" method="POST" class="pt-2 pb-2">
                    ...
                    <div class="form-check w-25">
                        <input type="checkbox" name="bimin[]" value="Basket" class="form-check-input">
                        <label>Basket</label>
                    </div>
                    <div class="form-check w-25">
                        <input type="checkbox" name="bimin[]" value="Futsal" class="form-check-input">
                        <label>Futsal</label>
                    </div>
                    <div class="form-check w-25">
                        <input type="checkbox" name="bimin[]" value="Tari" class="form-check-input">
                        <label>Tari</label>
                    </div>
                    <div class="form-check w-25">
                        <input type="checkbox" name="bimin[]" value="Duta Voice" class="form-check-input">
                        <label>Duta Voice</label>
                    </div>
                    <div class="form-check w-25">
                        <input type="checkbox" name="bimin[]" value="Musik" class="form-check-input">
                        <label>Musik</label>
                    </div>
...
</html><?php /**PATH C:\Users\User\LaravelPrelab10_72200390\resources\views/formulirmahasiswa.blade.php ENDPATH**/ ?>